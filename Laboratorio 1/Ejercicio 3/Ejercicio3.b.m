...
aprox = (y(x+h)-y(x-h))./(2*h); % aproximación de la derivada por diferencias
                                % finitas centrales
...
printf(">Aproximación por diferencias finitas centrales\n\n");
printf("función a proximar: "); display(y);
printf("para el valor: x=%d\n", x);
printf("valor real: %d\n", dydx);
printf("mejor aproximación: %d\n", min_v);
printf("menor error absoluto: %d\n", min_e);
printf("mejor paso h encontrado: %d\n", min_h);
printf("paso h sugerido sqrt(eps): %d\n", sqrt(eps));
